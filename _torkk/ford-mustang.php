...
<title>Ford Mustang Details | Torkk</title>
...
<div class="flex justify-between items-center mb-8">
    <a href="index.php" class="flex text-white items-center gap-2 text-4xl brand">
        <span>TORKK</span>
    </a>
...
<div class="bg-white p-8 rounded-xl shadow">
    <h2 class="text-3xl font-bold mb-4">Ford Mustang</h2>
    <img src="images/2015 Ford Mustang.jpg" alt="Ford Mustang" class="w-full h-64 object-cover rounded mb-4">
    <p class="text-gray-600 capitalize mb-2">Type: new</p>
    <p class="text-red-700 font-bold text-xl mb-4">Price: PKR 80,000,000</p>
    <p class="text-gray-700">The Ford Mustang is an American muscle car icon with thrilling performance, aggressive styling, and a legendary heritage.</p>
    <div class="mt-6 flex gap-4">
        <a href="https://www.ford.com/help/contact/" target="_blank" class="bg-cyan-400 text-white px-6 py-3 rounded hover:bg-blue-700">
            Contact Retailer
        </a>
