...
<title>Honda Civic Details | Torkk</title>
...
<div class="bg-white p-8 rounded-xl shadow">
    <h2 class="text-3xl font-bold mb-4">Honda Civic</h2>
    <img src="images/civic.jpg" alt="Honda Civic" class="w-full h-64 object-cover rounded mb-4">
    <p class="text-gray-600 capitalize mb-2">Type: used</p>
    <p class="text-red-700 font-bold text-xl mb-4">Price: PKR 8,000,000</p>
    <p class="text-gray-700">The Honda Civic is a compact car offering excellent fuel economy, sporty handling, and a spacious cabin for its class.</p>
    <ul>
  <li>Type: Gasoline</li>
  <li>Model: 2023</li>
  <li>KMs Driven: 20,000</li>
  <li>Inspected: Yes</li>
  <li>Engine: 1500 CC</li>
  <li>Average: 9 To 12</li>
</ul>
