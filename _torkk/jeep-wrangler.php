...
<title>Jeep Wrangler Details | Torkk</title>
...
<div class="bg-white p-8 rounded-xl shadow">
    <h2 class="text-3xl font-bold mb-4">Jeep Wrangler</h2>
    <img src="images/Jeep Wrangler….jpg" alt="Jeep Wrangler" class="w-full h-64 object-cover rounded mb-4">
    <p class="text-gray-600 capitalize mb-2">Type: used</p>
    <p class="text-red-700 font-bold text-xl mb-4">Price: PKR 23,000,000</p>
    <p class="text-gray-700">The Jeep Wrangler is an iconic off-road SUV with removable doors, rugged design, and exceptional off-road capabilities.</p>
 <ul>
  <li>Type: Gasoline</li>
  <li>Model: 2019</li>
  <li>KMs Driven: 50,000</li>
  <li>Inspected: No</li>
  <li>Engine: 3600 CC</li>
  <li>Average: 7 to 9</li>
</ul>
