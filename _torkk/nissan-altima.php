...
<title>Nissan Altima | Torkk</title>
...
<div class="bg-white p-8 rounded-xl shadow">
    <h2 class="text-3xl font-bold mb-4">Nissan Altima</h2>
    ...
    <p class="text-gray-700">The Altima is a luxury compact executive car with a sleek design, premium interior, and advanced infotainment system.</p>
    <div class="mt-6 flex gap-4">
        <a href="https://www.nissanusa.com/vehicles/cars/altima.html" target="_blank" class="bg-cyan-400 text-white px-6 py-3 rounded hover:bg-blue-700">
            Contact Retailer
        </a>
