...
<title>Chevrolet Tahoe Details | Torkk</title>
...
<div class="bg-white p-8 rounded-xl shadow">
    <h2 class="text-3xl font-bold mb-4">Bentley SuperSports</h2>
    <img src="images/supersports.jpg" alt="Chevrolet Tahoe" class="w-full h-64 object-cover rounded mb-4">
    <p class="text-gray-600 capitalize mb-2">Type: used</p>
    <p class="text-red-700 font-bold text-xl mb-4">Price: PKR 300,000,000</p>
    <p class="text-gray-700">Bentley Super Sports is the pinnacle of performance luxury, engineered for those who demand extreme power without compromising elegance.
...
Every curve, every stitch, and every roar reflects exclusivity, dominance, and refinement at the highest level of automotive excellence.</p>
    <ul>
  <li>Type: Gasoline</li>
  <li>Model: 2022</li>
  <li>KMs Driven: 3000</li>
  <li>Inspected: Yes</li>
  <li>Engine: 6000CC/W12</li>
  <li>Average: 6 to 7</li>
</ul>
