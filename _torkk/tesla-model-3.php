...
<title>Tesla Model 3 Details | Torkk</title>
...
<div class="bg-white p-8 rounded-xl shadow">
    <h2 class="text-3xl font-bold mb-4">Tesla Model 3</h2>
    <img src="images/2024 Tesla Model 3 EV.jpg" alt="Tesla Model 3" class="w-full h-64 object-cover rounded mb-4">
    ...
    <p class="text-gray-700">The Tesla Model 3 is an electric four-door sedan developed by Tesla. It features advanced autopilot, long range, and a minimalist design.</p>
