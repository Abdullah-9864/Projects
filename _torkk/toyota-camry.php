...
<title>Toyota Camry Details | Torkk</title>
...
<div class="bg-white p-8 rounded-xl shadow">
    <h2 class="text-3xl font-bold mb-4">Toyota Camry</h2>
    <img src="images/camry.jpg" alt="Toyota Camry" class="w-full h-64 object-cover rounded mb-4">
    <p class="text-gray-600 capitalize mb-2">Type: used</p>
    <p class="text-red-700 font-bold text-xl mb-4">Price: PKR 16,000,000</p>
    <p class="text-gray-700">The Toyota Camry is a reliable midsize sedan known for its fuel efficiency, comfort, and long-lasting performance.</p>
      <ul>
  <li>Type: Hybrid</li>
  <li>Model: 2023</li>
  <li>KMs Driven: 20,000</li>
  <li>Inspected: Yes</li>
  <li>Engine: 2500 CC</li>
  <li>Average: 14 TO 17</li>
</ul>
